# Source: https://github.com/sunsided/python-conv2d/blob/master/convolution_manual.py

import cv2
import numpy as np

# load the image and scale to 0..1
image = cv2.imread('../images/lenna.jpg', cv2.IMREAD_GRAYSCALE).astype(float) / 255.0
